...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: Nested function can access the variable internal because the function nestedFunction and the variable internal are all inside the myFunction scope. 
...
const zooAnimals = [
  ...
  */
  ...
  // console.log('Task 2 forEach', animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(zooAnimalsData) {
    let lcZooAnimals = zooAnimalsData.map(zooAnimalsData => {
  ...
  */
  ...
  function USApop(zooAnimalData) {
    const addedSum = zooAnimalData.reduce((total, currentValue) => {
  ...
  */
  function family(a, b) {
    return `my girlfriend is ${a}, my son is ${b}`;
  }
  function consume(a, b, cb) {
    return cb(a, b);
  }
//  console.log(family("Hailey", "Brayden"))
...
function greeting(firstName, lastName) {
  ...
  // console.log(greeting("Hailey", "Murphy"));
